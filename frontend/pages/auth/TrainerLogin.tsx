...
const TrainerLogin: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    console.log('Trainer login form submitted')
    ...
    try {
      console.log('Saving trainer auth to localStorage...')
      localStorage.setItem('authToken', 'trainer_token_' + Date.now())
      localStorage.setItem('role', 'trainer')
      localStorage.setItem('userEmail', email)
      
      console.log('Trainer token saved. authToken:', localStorage.getItem('authToken'))
      ...
      console.log('Trainer navigate called')
    } catch (err) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-purple-100 dark:border-gray-700 transition-colors duration-300">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Trainer Login !</h1>
            <p className="text-gray-600 dark:text-gray-400">Manage your clients and training sessions</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="trainer@muscles.fit"
